...
- `524834e`: 저장소 파일 정리.
- `57d85d8`: gateway HTTP bridge 와 session affinity 를 최적화하고, keepalive 처리, 압축 재시도 fallback, bridge 진단을 보강했습니다.
- `43778e4`: `prompt_cache_key` 전달을 개선하고 계정 무효 판정을 더 엄격하게 정리했습니다.

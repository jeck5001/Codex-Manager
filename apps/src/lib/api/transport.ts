...
const WEB_COMMAND_MAP: Record<string, WebCommandDescriptor> = {
  ...
  service_account_delete_banned: {
    rpcMethod: "account/deleteBanned",
  },
  ...
  service_plugin_upsert: { rpcMethod: "plugin/upsert" },
  service_plugin_delete: { rpcMethod: "plugin/delete" },
  ...
  service_stats_consumer_overview: { rpcMethod: "stats/consumer/overview" },
  service_stats_consumer_trend: { rpcMethod: "stats/consumer/trend" },
  service_stats_consumer_model_breakdown: { rpcMethod: "stats/consumer/modelBreakdown" },
  service_stats_consumer_ranking: { rpcMethod: "stats/consumer/ranking" },
  service_stats_cache_summary: { rpcMethod: "stats/cache/summary" },
  service_stats_cache_trend: { rpcMethod: "stats/cache/trend" },
  service_stats_cache_by_model: { rpcMethod: "stats/cache/byModel" },
  service_stats_cache_by_key: { rpcMethod: "stats/cache/byKey" },

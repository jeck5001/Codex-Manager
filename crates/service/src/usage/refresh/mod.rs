...
static AUTO_DISABLE_RISKY_ACCOUNTS_ENABLED: AtomicBool = AtomicBool::new(false);
static AUTO_DISABLE_RISKY_ACCOUNTS_FAILURE_THRESHOLD: AtomicUsize =
    AtomicUsize::new(DEFAULT_AUTO_DISABLE_RISKY_ACCOUNTS_FAILURE_THRESHOLD);
static AUTO_DISABLE_RISKY_ACCOUNTS_HEALTH_SCORE_THRESHOLD: AtomicUsize =
    AtomicUsize::new(DEFAULT_AUTO_DISABLE_RISKY_ACCOUNTS_HEALTH_SCORE_THRESHOLD);
static AUTO_DISABLE_RISKY_ACCOUNTS_LOOKBACK_MINS: AtomicU64 =
    AtomicU64::new(DEFAULT_AUTO_DISABLE_RISKY_ACCOUNTS_LOOKBACK_MINS);
...
const ENV_AUTO_DISABLE_RISKY_ACCOUNTS_ENABLED: &str =
    "CODEXMANAGER_AUTO_DISABLE_RISKY_ACCOUNTS_ENABLED";
const ENV_AUTO_DISABLE_RISKY_ACCOUNTS_FAILURE_THRESHOLD: &str =
    "CODEXMANAGER_AUTO_DISABLE_RISKY_ACCOUNTS_FAILURE_THRESHOLD";
const ENV_AUTO_DISABLE_RISKY_ACCOUNTS_HEALTH_SCORE_THRESHOLD: &str =
    "CODEXMANAGER_AUTO_DISABLE_RISKY_ACCOUNTS_HEALTH_SCORE_THRESHOLD";
const ENV_AUTO_DISABLE_RISKY_ACCOUNTS_LOOKBACK_MINS: &str =
...
const DEFAULT_SESSION_PROBE_INTERVAL_SECS: u64 = 1800;
...
const DEFAULT_AUTO_DISABLE_RISKY_ACCOUNTS_HEALTH_SCORE_THRESHOLD: usize = 60;
const DEFAULT_AUTO_DISABLE_RISKY_ACCOUNTS_LOOKBACK_MINS: u64 = 60;

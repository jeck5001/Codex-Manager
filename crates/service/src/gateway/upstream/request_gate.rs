...
pub(super) fn acquire_request_gate(
    trace_id: &str,
    key_id: &str,
    path: &str,
    model_for_log: Option<&str>,
    request_deadline: Option<Instant>,
) -> Option<super::super::request_gate::RequestGateGuard> {
    let request_gate_lock = super::super::request_gate_lock(key_id, path, model_for_log);
    let request_gate_wait_timeout = super::super::request_gate_wait_timeout();
    super::super::trace_log::log_request_gate_wait(trace_id, key_id, path, model_for_log);
            ...
            if let Ok(Some(guard)) = wait_result {
                ...
                match wait_result {
                    Err(super::super::RequestGateAcquireError::Poisoned) => {
                        super::super::trace_log::log_request_gate_skip(trace_id, "lock_poisoned");
                    }
                    _ => {
                        ...
                        super::super::trace_log::log_request_gate_skip(trace_id, reason);
                    }
                }
                None
            }

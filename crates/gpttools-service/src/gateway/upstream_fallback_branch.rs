...
{
    let should_fallback = super::should_try_openai_fallback(upstream_base, path, upstream_content_type)
        || super::should_try_openai_fallback_by_status(upstream_base, path, status.as_u16());
    if !should_fallback {
